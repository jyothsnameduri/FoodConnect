    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-montserrat font-bold text-2xl md:text-3xl text-[#424242] mb-4">Community Voices</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-[#F5F5F5] p-6 rounded-soft shadow-soft">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-montserrat font-semibold text-lg">{testimonial.name}</h3>
              ...
              <p className="testimonial text-[#424242]">
                "{testimonial.text}"
              </p>
            </div>
          ))}
